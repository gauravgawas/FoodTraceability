...
<html lang="en">
  <head>
    ...
    <link rel="SHORTCUT ICON" href="images/foop.png" type="image/x-icon" />
    <link rel="ICON" href="images/foop.png" type="image/ico" />

    <title>foop - Add New Products</title>
  ...
  <body style="background-color:#B0E0E6;">
            ...
            <div class="greyarea">
                ...
                <form id="form1" autocomplete="off">
                    <div class="formitem">
                        ...
                        <label type="text" class="formlabel"> Product Details</label>
                        <input type="text" class="forminput" id="pd" required>

                        <label type="text" class="formlabel"> Product Category</label>
                        <input type="text" class="forminput" id="pc" required>

                        <label type="text" class="formlabel"> Product Expiry </label>
                        <input type="date" class="forminput" id="exp" required>

                        <label type="text" class="formlabel"> Price / Unit </label>
                        <input type="number" class="forminput" id="pu" required>

                        <label type="text" class="formlabel"> Lot Size </label>
                        <input type="number" class="forminput" id="ls" required>
    ...
    $('#form1').on('submit', function(event) {
        ...
        web3.eth.getAccounts().then(async function(accounts) {
          var receipt = await contract.methods.newItem(prodname,expiry,pd,pu,ls,pc,thisdate).send({ from: accounts[0], gas: 1000000 })
          .then(receipt => {
