...
<html lang="en">
  <head>
    ...
    <title>foop - Decentralized Application</title>
  ...
  <body style="background-color:#B0E0E6;padding:10% 0% 20% 0%;">
  <?php
  ...
  <center> 
    ...
    <div style="padding:20px;margin:auto;width:20%;" class="img">
      <img src="images\foop.png" width="200px" height="200px">
      <div class="text">
    <p>EAT RIGHT</p>
    </div>
    </div>
      <div class="loginformcard" id="card1">
                <div class="cardbtnarea">
                    <button style="width:200px;" class="col-md-5 rolebtn" id="login">Login</button>
                </div>
                <div>
